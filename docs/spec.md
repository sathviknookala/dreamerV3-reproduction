...
| **Online loop, checkpoint/resume, evaluation policy (§7.6, §7.8, §8.1)** | **`specified`** — **not `implemented`.** Every component it would drive exists; nothing has stepped the environment with a learned policy. M9. |
